...
$id = $name = $phone  = $location = $cuisines = $review = $price = $image = $vote = $person_name = $blogs = $date = "";
   ...
   $conn = mysql_connect('localhost', 'root', 'sourcefuse');
    if(! $conn )
   {
		...
		<li><div class="fontsize">800for two people (approx.)</div></li>
						...
						<div class="center"></div>
							<div  class="menu"><b><u>Menu</u></b></div>
								<div>
					<ul>									
					<li><img src="img/image-1.jpg"  width="80" />
						<img src="img/image-2.jpg"  width="65" />
						<img src="img/images.jpg"  width="106" />
						<img src="img/download.jpg" width="100" /></li>
					</ul>
					</div>
					<div  class="photos" ><b><u>Photos</u></b></div>
					<div>
						<ul>
						<li><img src="img/thumb-2.jpg"  width="100"  height="80"/>
						<img src="img/thumb-1.jpg"  width="80" />
						<img src="img/images.jpg"  width="129" />
						<img src="img/images.jpg" width="129" />
						<img src="img/images.jpg" width="129" />
						<img src="img/images.jpg" width="129" /></li>
					</ul>
					</div>
				<div class="review">
					<ul>					
...
<td><textarea name="comment" rows="10" cols="60" placeholder="Tip: A great review covers food, service, and ambiance. Got recommendations for your favorite dishes and drinks, or something everyone should try here? Include that too! And remember, your review needs to be at least 140 characters long :)"></textarea></td></div>
					...
					</div> <div class="center"style="text-align: center">
						<ul>
						<li> 	
					<li><div class="head">FEEDBACK</div></li>
						<li><div class="pop"style="text-align: center">33</div>
						<div class="pop"style="text-align:center">a perfect place to go nd enjoy with family  </div>
						<div class="pop"style="text-align:center"></div></li>
						<div class="line"width="10%"></div>
					<li><div class="date">22/12/2015</div></li>
					<li><img src="img/icecream.png" width="20"style="vertical-align: middle">rahul</span></li>
					<li><div class="pop">3 days ago  via Zomato for Android</div></li>
					<li><div class="android" style="text-align: center"></div></li>
				</li>			
					</ul>						
				 </div>
<div class ="android" style="text-align:left"><u>RATED:</u></div>

<div class="android" style="text-align:center" width="">  Went to this place with a friend expecting out of the world pizzas but was surprised by the limited variety they have to offer. The hand stretched garlic bread was nice, the chicken diavola pizza, not so much. The pizza was over crispy, in fact, hard, towards the crust and extensively soggy towards the center. So much so, that when i lifted the slice, the front end was dipping as if it was a chapati.

When we called up someone from the restaurant to point out the same, the manager told us the oldest dialogue in the book, "this pizza is like this only." He further added that this pizza is supoosed to be eaten with a fork and knife, so we decided to give it a go.

But the problem was, that we had to eat 40% of every slice with a fork and knife, another 40% by directly biting into it, coz the fork n knife weren't helping and leave the crust as it was unbreakable.

Nice iced teas, though
Like 2			</div>
...
Like 2			</div>
			...
			<div class="right"style="min-height: 1436px;" >
				<div class="box1">
				<ul>				
